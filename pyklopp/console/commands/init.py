...
class InitCommand(Command):
    ...
    def handle(self):
        ...
        save_path_base = None
        if self.option('save'):
            save_path_base = str(self.option('save'))
        ...
        config = {
            ...
            'model_persistence_name': 'initial-model.pth',  # If none, model will not be persisted
        }
        ...
        if save_path_base is not None:
            if config['model_persistence_name'] is not None:
